...
return g.promise()
    ...
    if(a.attachEvent)for(t in{
        ...
        change:1,
        focusin:1
    })s="on"+t,u=s in a,u||(a.setAttribute(s,"return;"),u=typeof a[s]=="function"),k[t+"Bubbles"]=u;o=l=g=h=m=j=a=i=null;
    return k
...
setup:function(a,b){
    ...
    for(var c in H)f.event.add(this,c+".specialChange",H[c]);return y.test(this.nodeName)
    },
teardown:function(a){
...
param:function(a,c){
    ...
    if(f.isArray(a)||a.jquery&&!f.isPlainObject(a))f.each(a,function(){
        ...
        });else for(var g in a)bY(g,a[g],c,e);return d.join("&").replace(bB,"+")
    }
}),f.extend({
    active:0,
    lastModified:{},
...
animate:function(a,b,c,d){
    ...
    return this[e.queue===!1?"each":"queue"](function(){
        ...
        for(i in a)k=new f.fx(this,b,i),h=a[i],cj.test(h)?k[h==="toggle"?d?"show":"hide":h]():(l=ck.exec(h),m=k.cur(),l?(n=parseFloat(l[2]),o=l[3]||(f.cssNumber[i]?"":"px"),o!=="px"&&(f.style(this,i,(n||1)+o),m=(n||1)/k.cur()*m,f.style(this,i,m+o)),l[1]&&(n=(l[1]==="-="?-1:1)*n+m),k.custom(m,n,o)):k.custom(m,h,""));return!0
        })
    },
stop:function(a,b){
