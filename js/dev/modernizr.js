...
window.Modernizr=function(a,b,c){
    ...
    r.flexbox=function(){
        ...
        for(var b=-1,c=p.length;++b<c;)if(a[p[b].toLowerCase()+"IndexedDB"])return!0;return!!a.indexedDB
        ...
        for(var b=-1,c=p.length;++b<c;)if(a[p[b]+"WebSocket"])return!0;return"WebSocket"in a
        },r.rgba=function(){
...
for(var J in r)A(r,J)&&(y=J.toLowerCase(),e[y]=r[J](),u.push((e[y]?"":"no-")+y));e.input||I(),e.addTest=function(a,b){
        ...
        if(a&&p&&s-p<i)clearTimeout(q),q=setTimeout(r,i);
            ...
            for(var t in e){
                ...
                if(!u.minw&&!u.maxw||(!u.minw||u.minw&&l>=u.minw)&&(!u.maxw||u.maxw&&l<=u.maxw))m[u.media]||(m[u.media]=[]),m[u.media].push(f[u.rules])
                    ...
                    for(var t in g)g[t]&&g[t].parentNode===j&&j.removeChild(g[t]);for(var t in m){
